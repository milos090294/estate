                ...
                <div class="col s12 m8">
                    ...
                    <div class="card" id="comments">
                        <div class="p-15 grey lighten-4">
                            <h5 class="m-0">{{ $post->comments_count }} Komentari</h5>
                        </div>
                        <div class="single-narebay p-15">
                                    ...
                                    <div class="comment">
                                        ...
                                        <div class="content">
                                            <div class="author-name">
                                                ...
                                                @auth
                                                    <span class="right replay" data-commentid="{{ $comment->id }}">Odgovori</span>
                                                @endauth
                            ...
                            @guest 
                                <div class="comment-login">
                                    <h6>Uloguj se da bi komentarisao</h6>
                                    <a href="{{ route('login') }}" class="btn indigo">Uloguj se</a>
                                </div>
                            @endguest
