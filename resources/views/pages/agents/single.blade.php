        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col s12 m8">
                    ...
                    <h5 class="uppercase">Nekretnine od  {{ $agent->name }}</h5>
                        ...
                        <div>
                            <ul class="collection with-header m-t-0">
                                <li class="collection-header grey lighten-4">
                                    <h5 class="m-0">Kontaktiraj agenta</h5>
                                </li>
                                <li class="collection agent-message">
                                    <form class="agent-message-box" action="" method="POST">
                                        ...
                                        <div class="box">
                                            <input type="text" name="name" placeholder="Tvoje Ime">
                                        </div>
                                        <div class="box">
                                            <input type="email" name="email" placeholder="Tvoj Email">
                                        </div>
                                        <div class="box">
                                            <input type="number" name="phone" placeholder="Tvoj Telefon">
                                        </div>
                                        <div class="box">
                                            <textarea name="message" placeholder="Tvoja Poruka"></textarea>
                                        </div>
                                        <div class="box">
