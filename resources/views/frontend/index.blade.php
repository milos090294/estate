...
@section('content')
    ...
    <section class="section grey lighten-4 center">
        <div class="container">
            <div class="row">
                <h4 class="section-heading">Servisi</h4>
            </div>
            <div class="row">
                @foreach($services as $service)
                    <div class="col s12 m4">
                        <div class="card-panel">
                            <i class="material-icons large " style="color:#ffcc41;">{{ $service->icon }}</i>
                            <h5>{{ $service->title }}</h5>
    ...
    <section class="section">
        <div class="container">
            <div class="row">
                <h4 class="section-heading">Nekretnine</h4>
            </div>
            <div class="row">
                        ...
                        <div class="card">
                            ...
                            <div class="card-action property-action">
                                <span class="btn-flat">
                                    ...
                                    Sobe: <strong>{{ $property->bedroom}}</strong> 
                                </span>
                                <span class="btn-flat">
                                    <i class="material-icons">check_box</i>
                                    Kupatilo: <strong>{{ $property->bathroom}}</strong> 
                                </span>
                                <span class="btn-flat">
                                    <i class="material-icons">check_box</i>
                                    Area: <strong>{{ $property->area}}</strong> Sprat
                                </span>
                                <span class="btn-flat">
    ...
    <section class="section grey lighten-3 center">
        <div class="container">
            ...
            <h4 class="section-heading">Iskustva</h4>
    ...
    <section class="section center">
        <div class="row">
            <h4 class="section-heading">Najnoviji Blogovi</h4>
        </div>
        <div class="container">
            <div class="row">
