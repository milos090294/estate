    ...
    <div class="container">
        <div class="row">
            <div class="col m4 s12">
                <h5 class="white-text uppercase">O nama</h5>
                @if(isset($footersettings[0]) && $footersettings[0]['aboutus'])
                    <p class="grey-text text-lighten-4">{{ $footersettings[0]['aboutus'] }}</p>
                @else
                    <p class="grey-text text-lighten-4">Naša agencija za prodaju nekretnina je pouzdana i stručna tvrtka koja vam pruža sveobuhvatne usluge u kupovini i prodaji nekretnina. Sastavljena od iskusnih agenata za nekretnine, naša ekipa je posvećena pronalaženju idealnih nekretnina za naše klijente i osiguravanju glatke i uspješne transakcije.</p>
                @endif
            </div>
            <div class="col m6 s12">
                <h5 class="white-text uppercase">Najnovije Nekretnine</h5>
                <ul class="collection border0">
                    ...
                    <li class="collection-item transparent clearfix p-0 border0">
                        ...
                        <div class="float-left">
                            ...
                            <p class="m-t-0 m-b-5 grey-text text-lighten-1">Sobe: {{ $property->bedroom }} Kupatila: {{ $property->bathroom }} </p>
                        </div>
                    </li>
                    @endforeach
            ...
            <div class="col m2 s12">
                ...
                <ul>
                    <li class="uppercase {{ Request::is('property*') ? 'underline' : '' }}">
                        <a href="{{ route('property') }}" class="grey-text text-lighten-3">Nekretnine</a>
                    </li>
                    ...
                    <li class="uppercase {{ Request::is('gallery*') ? 'underline' : '' }}">
                        <a href="{{ route('gallery') }}" class="grey-text text-lighten-3">Galerija</a>
                    </li>
                    ...
                    <li class="uppercase {{ Request::is('contact') ? 'underline' : '' }}">
                        <a href="{{ route('contact') }}" class="grey-text text-lighten-3">Kontakt</a>
                    </li>
                </ul>
            </div>
        </div>
